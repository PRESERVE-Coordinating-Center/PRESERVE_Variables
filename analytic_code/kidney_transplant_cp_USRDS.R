...
#' Identify cohort with a kidney transplant procedure 
#' The computable phenotype was developed to query patients who had undergone kidney transplant 
#' and was validated against USRDS dataset and a subset of chart review patients. 
#' The most optimal algorithm for identifying children with kidney transplant used one code from Group A (more specific) 
#' and two distinct codes from Group B (more sensitive), achieving an F1 score of 0.93 (95% CI 0.89-0.97), 
#' a PPV of 90.7% (95% CI 84.2%-95.8%), and sensitivity of 96.0% (95% CI 91.8%-100.0%). 
#' 
#' This function is a wrapper of the get_chronic_dialysis_cohort function with no egfr requirement.
...
#' @param kidney_transplant_codeset Validated chronic dialysis codeset 
...
get_kidney_transplant_cohort <- function(cohort_tbl, 
                                        ...
                                        min_age,
                                        max_age,
                                        kidney_transplant_codeset = load_codeset("kidney_transplant_cp_USRDS"),
                                        num_egfr = 0,
                                        max_egfr_val = NA){

    get_chronic_dialysis_cohort(cohort_tbl, 
                                min_date_cutoff,
                                max_date_cutoff, 
                                min_age,
                                max_age,
