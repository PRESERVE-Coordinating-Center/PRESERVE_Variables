...
create temporary table cakut as (
...
--removed PKD codes (found by pkd_dx_codes.sql)
select * from cakut
where concept_id not in (45544102, 45558415, 1572110, 45587467, 35211019, 44820018, 44828106, 4109637, 4109809, 4109022, 436232, 201675, 37109646, 35623051, 35623052)
and concept_name ilike '%cyst%'
--scratch work