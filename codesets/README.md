...
| rx_nephrotoxic_cdf_ndc_atc | [rx_nephrotoxic_cdf_ndc_atc](https://github.com/PRESERVE-Coordinating-Center/PRESERVE_Variables/tree/main/codesets/drug/rx_nephrotoxic_cdf_ndc_atc.csv) | Nephrotoxic medications were identified based on a list used by the NINJA ([Nephrotoxic Injury Negated by Just-in-Time Action](https://doi.org/10.1542/peds.2013-0794)) project. List updated based on communication with NINJA group 02/03/2023.  | NDC, RxNorm, RxNorm Extension |  | 2023-05 | Amy Goodwin Davies | vocab-based |  |  |
